...
*Result:*
> 2. I use two characters and create a short cinematic moment: after the spaceship crash/landing, both characters run away from the ship and move toward a target point (for example, a building). This sequence is controlled through a Blueprint called BP_RunPath.
